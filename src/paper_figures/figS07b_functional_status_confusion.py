...
# Builds publication figure module `figS07b_functional_status_confusion`.
#
...
# Usage: `python -m src.paper_figures.figS07b_functional_status_confusion` or `python scripts/build_paper_figures.py`.
