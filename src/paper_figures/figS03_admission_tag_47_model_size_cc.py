...
# Builds publication figure module `figS03_admission_tag_47_model_size_cc`.
#
...
# Usage: `python -m src.paper_figures.figS03_admission_tag_47_model_size_cc` or `python scripts/build_paper_figures.py`.
...
def build() -> plt.Figure:
    df = load_model_size_common_for_variant("C")
    ...
    return render_single_matrix(
        figure_name="S3_admission-tag-47_model-size_CC",
        tags=tags,
        rates=rates,
    )
