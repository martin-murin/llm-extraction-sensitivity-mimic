...
# Builds publication figure module `figS03_admission_tag_47_model_size_bb`.
#
...
# Usage: `python -m src.paper_figures.figS03_admission_tag_47_model_size_bb` or `python scripts/build_paper_figures.py`.
...
def build() -> plt.Figure:
    df = load_model_size_common_for_variant("B")
    ...
    return render_single_matrix(
        figure_name="S3_admission-tag-47_model-size_BB",
        tags=tags,
        rates=rates,
    )
